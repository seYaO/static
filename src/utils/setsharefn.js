...
var setShareFun = {
    ...
    changeShareInfo: function () {
        ...
        if (isAndroid && isTc) {
            Android.setTcshareimg(shareImg);
            Android.setTcshareurl(shareUrl);
            Android.setTcsharetext(shareTitle);
            Android.setTcsharedesc(shareDesc);
        }
...
/*
 *  setShareFun.shareImg = "";
 *  setShareFun.shareTitle = "";
 *  setShareFun.shareDesc = "";
 *  setShareFun.shareUrl = "";
